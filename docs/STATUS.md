...
0. **Click-test the Rules, notification-preferences, search, and AI UI in a real browser** (gaps #20/#22/#24/#26 above) - create a rule, toggle enable/disable, run a test, view execution history, set silent hours and confirm the tiered chimes and suppression actually work live, confirm the search box returns and opens the right results, and confirm the Summarize/Suggest-replies buttons and AI rule-suggestion panel work live.
